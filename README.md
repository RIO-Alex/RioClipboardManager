...
## ✨ Основные функции
* **Тихая работа:** Приложение запускается сразу в трее и не мешает до тех пор, пока не понадобится.
...
4. После установки, если активен чекбокс автоматического запуска, приложение сразу запустится в трее. 
